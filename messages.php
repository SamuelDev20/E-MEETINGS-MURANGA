...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#advancesalary">
  send messages
</button>

<!-- Modal -->
<div class="modal fade" id="advancesalary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					if(mysqli_num_rows($gotResults)>0){
						while ($row = mysqli_fetch_array($gotResults)) {
							...
							//print_r($row['firstname']);
								...
								?>
							<tr>
                            <td><b><h5>Subject:</h5></b><b><?php echo $row['subject'];?></b>
							  <br><h5>Message:</h5><?php echo $row['message'];?>
							  <br><b>From: </b><?php echo $row['from'];?>
